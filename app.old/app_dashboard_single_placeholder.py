...
# Render the whole dynamic area inside a single placeholder.
# This makes Streamlit replace one stable container on every rerun instead of
# occasionally leaving old chart elements visible after starting a new session.

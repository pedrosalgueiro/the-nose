...
with dashboard_tab:
    dash_left, dash_mid, dash_right = st.columns([1.05, 1.05, 0.95])
    ...
    with dash_left:
        ...
        if full_bundle is None:
            ...
            st.info("Aparece após ~60 s; resultado oficial aos 180 s.")
    ...
    with dash_mid:
        ...
        if continuous_prediction is None:
            ...
            st.info(f"A aguardar primeira previsão contínua. Faltam ~{missing} s.")
        else:
            st.metric(
                "Tempo real",

...
# The Streamlit tabs were causing duplicated old tab content after starting
# a second sample in some browser/runtime combinations. For the demo, keep
# the dashboard as a single page so only one set of cards/charts is rendered.

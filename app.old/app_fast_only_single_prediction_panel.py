...
DEFAULT_FULL_MODEL_PATH = "models/electronic_nose_fast_lemon.joblib"
DEFAULT_FAST_MODEL_PATH = "models/electronic_nose_fast_lemon.joblib"
...
with control_c:
    st.info(
        "Modo atual: apenas modelo rápido. "

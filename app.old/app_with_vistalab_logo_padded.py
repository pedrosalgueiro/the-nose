...
header_left, header_mid, header_right = st.columns([0.55, 3.20, 2.25])
...
with header_right:
    ...
    if SHOW_VISTALAB_LOGO and vistalab_logo_path.exists():
        # Use a base64 HTML image instead of st.image.
        # st.image inside a Streamlit column can crop very wide logos vertically
        # depending on the column height. This keeps the whole logo visible.
        import base64

        logo_b64 = base64.b64encode(vistalab_logo_path.read_bytes()).decode("ascii")
        st.markdown(
            f"""
            <div style="
                width:100%;

...
with control_c:
    st.info(
        ...
        "35–90 s exposição, 90–180 s recuperação. Aos 180 s a previsão rápida congela."
    )
...
with metric_cols[3]:
    st.metric(
        "Sessão",
        "Congelada" if display_full_prediction is not None else "Em curso",
    )
...
if display_full_prediction is not None:
    st.success("Sessão concluída: a previsão rápida foi congelada aos 180 s.")

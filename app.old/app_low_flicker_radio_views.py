...
# The browser-side timer stays smooth; 1250 ms reduces full-page rerun flicker.
read_interval_ms = 1250
broker = "10.0.0.2"
port = 1883
username = ""
password = ""
...
if view == "Dashboard":
    ...
    with st.expander("⚙️ Configuração avançada", expanded=False):
        ...
        with cfg_col1:
            st.write("**Leitura**")
            st.write(f"Intervalo de refresh/backend: `{read_interval_ms} ms`")
